				<?php 
				$content_type='news';
				$taxonomy = reset(taxonomy_get_term_by_name('Activity', 'news_type'));
				...
				<div id="activity-news" class="box">
					<div class="header row-fluid">
						<div class="span12">
							<a href="/news/activity/archive">			
								<div class="icon"><img width="80" height="80" src="<?php echo "$base_path$directory/images/"?>icon-news-retina.png"></div>
								<div class="title">ACTIVITY NEWS</div>
							</a>
							<div class="tools">
								<div class="position">
											...
											<div class="text">
												...
												<span>
													...
													foreach($node->field_news_tag['und'] as $tag) {
														$tag_full = check_plain(taxonomy_term_load($tag['tid']));
														echo "<a href='/news/activity/archive/?tag=" . check_plain($tag_full->name) . "'>" . check_plain(strtoupper($tag_full->name)) . "</a> ";
													}
													?>
												</span>
