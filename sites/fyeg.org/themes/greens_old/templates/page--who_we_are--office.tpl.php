...
<?php 
	...
	foreach ($nodes as $node) {
			$node_num++;
			$image_url = $node->field_photo['und']['0']['uri'];
			$photo_thumbnail_url = check_url(image_style_url('people_image_circle', $image_url));
	?>
	
	<div class="span6">
		<div class="box launch-box office">
			<div class="content">
				<div class="header row-fluid">
					<div class="span12">
						...
						<div class="members-thumbnail">
							...
							<div class="name"><?php echo check_plain($node->field_first_name['und']['0']['value'])?></div>
							<div class="lastname"><?php echo check_plain($node->field_last_name['und']['0']['value'])?></div>
							<div class="nationality"><?php echo check_plain($node->field_age['und']['0']['value'])?>, <?php echo $node->field_nationality['und']['0']['value']?></div>
							<div class="email">Email: <a href="mailto:<?php echo check_url($node->field_email['und']['0']['value'])?>"><?php echo check_plain($node->field_email['und']['0']['value'])?></a></div>
